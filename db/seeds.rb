...
Setup.create({ key: "site_solr_url", value: "http://localhost:8983" })
...
Setup.create({ key: "enable_searchresults_watch", value: "false"})
Setup.create({ key: "enable_searchresults_unwatch", value: "false"})
