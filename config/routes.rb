...
#    get '/search/add_tw_constraint' => 'search#add_tw_constraint'
  ...
  #post '/search/remove_format' => 'search#remove_format'
	...
	post '/results/get_annotation' => 'results#get_annotation'
	post '/results/get_annotation_feedback' => 'results#get_annotation_feedback'
...
#	get "/admin/default/vic_conference" => "admin/default#vic_conference"
  ...
  match '/annotationreview' => 'review#index'
  post '/review/get_review_info' => 'review#get_review_info'
  post '/review/get_review_feedback' => 'review#get_review_feedback'
