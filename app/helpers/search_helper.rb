...
#      ret[:value] = value_display
  ...
  def forum_result_row_item(type, hit, key, label)
	...
	def result_row_tags_links(rows, index, row_id, hit, label, tags, item, signed_in, is_collected)
		...
		tags.each { |tag|
			...
			if current_user && get_curr_user_id == tag[1][:user]
  ...
  def create_roles_table( _data )
    ...
    html += raw("<tr><th colspan=2>Roles</th></tr>")
  ...
  def create_coverage_table( genre_data )
    ...
    html += raw("<tr><th colspan=\"2\" id=\"coverage_table_header\">Coverage</th></tr>")
    html += raw("<tr><td class=\"limit_to_lvl1\">Not enough data to show this facet</td><td>&nbsp;</td></tr>")
    html += raw('</table>')
  ...
  def create_imprint_table(imprint_data)
    ...
    html += raw("<tr><th colspan=\"2\" id=\"imprint_table_header\">Imprint</th></tr>")
    html += raw("<tr><td class=\"limit_to_lvl1\">Not enough data to show this facet</td><td>&nbsp;</td></tr>")
    html += raw('</table>')
  ...
  def create_subject_table(subject_data)
    ...
    html += raw("<tr><th colspan=\"2\" id=\"subject_table_header\">Subject</th></tr>")
    html += raw("<tr><td class=\"limit_to_lvl1\">Not enough data to show this facet</td><td>&nbsp;</td></tr>")
    html += raw('</table>')
  ...
  def create_language_table(language_data)
    ...
    html += raw("<tr><th colspan=\"2\" id=\"language_table_header\">Language</th></tr>")
    html += raw("<tr><td class=\"limit_to_lvl1\">Not enough data to show this facet</td><td>&nbsp;</td></tr>")
    html += raw('</table>')
  ...
  def create_publication_year_table(publication_year)
    ...
    html += raw("<tr><th colspan=\"2\" id=\"publication_year_table_header\">Publication Date(YYYY)</th></tr>")
    html += raw("<tr><td class=\"limit_to_lvl1\">Not enough data to show this facet</td><td>&nbsp;</td></tr>")
    html += raw('</table>')
  ...
  def create_type_table(type_data)
    logger.info "This is from create_type_table"

    html = raw('<table id="type_table" class="limit_to type-format">')
    html += raw("<tr><th colspan=\"2\" id=\"type_table_header\">Type</th></tr>")
    html += raw("<tr><td class=\"limit_to_lvl1\">Not enough data to show this facet</td><td>&nbsp;</td></tr>")
    html += raw('</table>')
